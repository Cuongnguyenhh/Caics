...
<script src="https://kit.fontawesome.com/b907c217d3.js" crossorigin="anonymous"></script>
    ...
    <!-- Css Styles -->
    <base href="<?php echo e(('./public/frontend')); ?>/">
...
<body ng-app="myApp" ng-controller="CartController">
  ...
  <div class="tip" ng-bind="cartCount"></div>
        ...
        <div class="offcanvas__auth">
            <a href="<?php echo e(URL::asset('/signup')); ?>">Login</a>
            <a href="<?php echo e(URL::asset('/signup')); ?>">Register</a>
        </div>
    </div>
    <!-- Offcanvas Menu End -->
                    ...
                    <div class="header__right">
                        <div class="header__right__auth" style="margin-top: -30px;">
                            ...
                            if (isset($_SESSION['login'])) {
                                ...
                                <ul>
                                    <li><a class"loginname" href="">'.$_SESSION['login']['name'].'</a>
                                        <ul class="dropdown">
    ...
    <!-- Header Section End -->
        <?php echo $__env->yieldContent('shop_content'); ?>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/caics/resources/views/shop.blade.php ENDPATH**/ ?>