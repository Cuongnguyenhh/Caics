...
<div class="col-xl-4 col-lg-5 col-md-7 mx-auto"  ng-controller="userControl">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form">
                <div class="mb-3">
                  <input type="email" class="form-control" placeholder="Email" aria-label="Email" ng-model="formData.email" required>
                </div>
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="Password" aria-label="Password" ng-model="formData.pass" required>
                </div>
             
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" ng-click="login()">Sign in</button>
                </div>
              </form>
              <p class="text-sm mt-3 mb-0">You dont already have an account? <a href="<?php echo e(URL::asset('/signup')); ?>" class="text-dark font-weight-bolder">Sign up</a></p>

            </div>
          </div>
        </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('sign-up', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Caics/resources/views/pages-home/sign-in.blade.php ENDPATH**/ ?>