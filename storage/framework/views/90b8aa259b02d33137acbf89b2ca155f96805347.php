            ...
            <div class="card-body" >
              <form role="form">
                ...
                <div class="text-center">
                  <button type="button" class="btn bg-gradient-dark w-100 my-4 mb-2" ng-click=add()>Sign up</button>
                </div>
...
<?php echo $__env->make('sign-up', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Caics/resources/views/pages-home/sign-up.blade.php ENDPATH**/ ?>